...
public:
   ...
   void resetAll();
   void resetBreeze() {isBreeze = false;}
   void resetBump() {isBump = false;}
   void resetGlitter() {isGlitter = false;}
   void resetScream() {isScream = false;}
   void resetStench() {isStench = false;}
