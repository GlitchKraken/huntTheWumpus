...
void WumpusWorld::applyAction(action a)
{
   ...
   numActionsTaken += 1;
   playerScore -= 1;
   currentSensor.resetBump();
   currentSensor.resetScream();
   switch (a)
   {
   case climbOut:
...
int WumpusWorld::randomInt(int n) const
{
